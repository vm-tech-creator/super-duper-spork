        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className={`grid gap-4 ${categories.length === 3 ? 'sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3' : 'sm:grid-cols-2 lg:grid-cols-4'}`}>
            ...
            {categories.map((cat) => {
              ...
              const cardClass = `group relative overflow-hidden rounded-2xl bg-[#0c1829]/70 p-8 pb-7 shadow-[0_4px_40px_rgba(0,0,0,0.2)] backdrop-blur-sm transition duration-300 hover:-translate-y-1 hover:shadow-[0_20px_50px_rgba(0,0,0,0.35)]`;
